...
public interface DatasetRepository extends JpaRepository<Dataset, Long> {
    ...
    @Query(value = "select * from dataset s where s.form = :formId", nativeQuery = true)
    ...
    List<Dataset> findByAppId(@Param("appId") long appId);

    @Query(value = "select * from dataset s where s.id in (:ids)", nativeQuery = true)
