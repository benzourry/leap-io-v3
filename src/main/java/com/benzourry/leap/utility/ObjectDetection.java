...
////
////        Translator<Image, Classifications> translator =  YoloV5Translator
////                .builder()
////                .setPipeline(pipeline)
////                .optSynset(Arrays.asList("person"))
////                .optThreshold(0.8f)
////                .build();
////
////
...
////                .optTranslator(ImageClassificationTranslator.builder().optSynsetUrl("https://io.ireka.my/api/entry/file/7569_1726554952_synset.txt").build())
...
////
//
////        DetectedObjects detection = detect();
//        Classifications detection = classify();
//        logger.info("{}", detection);
//    }
//
//
//    public static DetectedObjects detect() throws IOException, ModelException, TranslateException {
//        Path imageFile = Paths.get("C:\\var\\iris-files\\attachment\\cogna-42\\person.jpg");
//        Image img = ImageFactory.getInstance().fromFile(imageFile);
//
//
//
//        ModelZoo.listModels().keySet().forEach(System.out::println);
//
...
////                        .optModelPath(Paths.get("C:\\var\\yolov8n\\yolov8n.onnx"))
...
//
//
//    public static Classifications classify() throws IOException, ModelException, TranslateException {
////        Path imageFile = Paths.get("C:\\var\\iris-files\\attachment\\cogna-42\\person.jpg");
//        Path imageFile = Paths.get("C:\\var\\iris-files\\troley.png");
//        Image img = ImageFactory.getInstance().fromFile(imageFile);
//
////        ModelZoo.listModels().keySet().forEach(System.out::println);
//
////        ModelZoo.listModels().values().forEach(l-> l.forEach(artifact -> System.out.println(artifact)));
////                Pipeline pipeline = new Pipeline();
...
////
////                Translator<Image, Classifications> translator =  ImageClassificationTranslator
////                    .builder()
////                    .setPipeline(pipeline)
////                    .optSynset(Arrays.stream(synset.split("\n")).toList())
////                    .addTransform(new Normalize(mean, standardDeviation))
//////                    .optThreshold(0.8f)
////                    .build();
//
//
...
////                        .optModelUrls("djl://ai.djl.onnxruntime/resnet/0.0.1/resnet101_v1")
...
////        Path imageFile = Paths.get("C:/var/iris-files/dog.jpeg");
////        Image img = ImageFactory.getInstance().fromFile(imageFile);
////
////        int imageSize = 640;
////        Pipeline pipeline = new Pipeline();
...
//////                        .optModelPath(p)
////                        .optModelUrls("file://C:/var/yolov8n.zip")
