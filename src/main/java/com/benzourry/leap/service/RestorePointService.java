...
public class RestorePointService {
    ...
    private final Map<String, String> COLUMN_NAME_MAP = Stream.of(new String[][]{
            ...
            {"form", "`id`, `admin`, `align`, `code_format`, `description`, `end_date`, `f`, `icon`, `nav`, `start_date`, `title`, `access_list`, `app`, `prev`, `counter`, `can_edit`, `can_retract`, `can_save`, `can_submit`, `validate_save`, `add_mailer`, `hide_status`, `on_save`, `on_submit`, `on_view`, `retract_mailer`, `single`, `single_q`, `update_appr_mailer`, `update_mailer`, `show_index`, `x`, `public_ep`, `sort_order`, `krypta` "},
            ...
            {"chart", "`id`, `agg`, `can_view`, `description`, `field_code`, `field_value`, `height`, `root_code`, `root_value`, `size`, `sort_order`, `status`, `status_filter`, `prev_status_filter`, `title`, `type`, `dashboard`, `form`, `preset_filters`, `field_series`, `root_series`, `series`, `show_agg`, `x`, `endpoint`, `f`, `source_type` "},
            {"chart_filter", "`id`, `code`, `form_id`, `label`, `preset`, `root`, `sort_order`, `chart`, `prefix`, `type` "},
            {"dataset", "`id`, `code`, `description`, `export_csv`, `export_pdf`, `export_pdf_layout`, `export_xls`, `preset_filters`, `show_action`, `show_status`, `size`, `sort_order`, `status`, `status_filter`, `prev_status_filter`, `title`, `type`, `ui`, `ui_template`, `access_list`, `app`, `form`, `wide`, `blast_to`, `can_blast`, `default_sort`,`def_sort_field`,`def_sort_dir`, `show_index`, `public_ep`, `inpop` "},
    ...
    private final Map<String, String> BACKUP_SQL_MAP = Stream.of(new String[][]{
            ...
            {"form", "insert ignore into #BACKUP_DB#.form " +
                    "      (`id`, `admin`, `align`, `code_format`, `description`, `end_date`, `f`, `icon`, `nav`, `start_date`, `title`, `access_list`, `app`, `prev`, `counter`, `can_edit`, `can_retract`, `can_save`, `can_submit`, `validate_save`, `add_mailer`, `hide_status`, `on_save`, `on_submit`, `on_view`, `retract_mailer`, `single`, `single_q`, `update_appr_mailer`, `update_mailer`, `show_index`, `x`, `public_ep`, `sort_order`, `krypta`, `hash`) " +
                    "select `id`, `admin`, `align`, `code_format`, `description`, `end_date`, `f`, `icon`, `nav`, `start_date`, `title`, `access_list`, `app`, `prev`, `counter`, `can_edit`, `can_retract`, `can_save`, `can_submit`, `validate_save`, `add_mailer`, `hide_status`, `on_save`, `on_submit`, `on_view`, `retract_mailer`, `single`, `single_q`, `update_appr_mailer`, `update_mailer`, `show_index`, `x`, `public_ep`, `sort_order`, `krypta`, :hash from #ACTIVE_DB#.form " +
                    "where app = :appId"},
            ...
            {"chart", "insert ignore into #BACKUP_DB#.chart " +
                    "      (`id`, `agg`, `can_view`, `description`, `field_code`, `field_value`, `height`, `root_code`, `root_value`, `size`, `sort_order`, `status`, `status_filter`, `prev_status_filter`, `title`, `type`, `dashboard`, `form`, `preset_filters`, `field_series`, `root_series`, `series`, `show_agg`, `x`, `endpoint`, `f`, `source_type`, `hash`) " +
                    "select `id`, `agg`, `can_view`, `description`, `field_code`, `field_value`, `height`, `root_code`, `root_value`, `size`, `sort_order`, `status`, `status_filter`, `prev_status_filter`, `title`, `type`, `dashboard`, `form`, `preset_filters`, `field_series`, `root_series`, `series`, `show_agg`, `x`, `endpoint`, `f`, `source_type`, :hash from #ACTIVE_DB#.chart " +
            ...
            {"dataset", "insert ignore into #BACKUP_DB#.dataset " +
                    "      (`id`, `code`, `description`, `export_csv`, `export_pdf`, `export_pdf_layout`, `export_xls`, `preset_filters`, `show_action`, `show_status`, `size`, `sort_order`, `status`, `status_filter`, `prev_status_filter`, `title`, `type`, `ui`, `ui_template`, `access_list`, `app`, `form`, `wide`, `blast_to`, `can_blast`, `default_sort`,`def_sort_field`,`def_sort_dir`, `show_index`, `public_ep`,`inpop`,`x`, `hash`) " +
