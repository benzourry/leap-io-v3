...
//                                    ));
                                    ...
                                    predicates.add(cb.upper(cb.function("JSON_VALUE", String.class,
                                                    predRoot,
...
//                            orders.add(cb.asc(path));
                                if (Arrays.asList("date", "number", "scaleTo10", "scaleTo5").contains(form.getItems().get(fieldCode).getType())) {
